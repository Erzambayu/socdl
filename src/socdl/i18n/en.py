STRINGS = {
    ...
    "info_title": "Media info",
    "info_fetching": "Fetching media info...",
    "info_unavailable": "No extra details available for this link.",
    "info_title_field": "Title",
    ...
    "info_shares": "Shares",
    "info_reposts": "Reposts",
    "cmd_help_info": "Show likes/comments/shares for a link (or /info <url>)",
    "cmd_info_usage": "Usage: /info <url> (or paste a link first)",
    "cmd_info_empty": "Nothing to look up yet.",
